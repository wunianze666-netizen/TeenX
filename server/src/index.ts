...
import { assertTeenxChildDeployment } from "./teenx-child-config.js";
...
export async function startServer(): Promise<StartedServer> {
  ...
  assertTeenxChildDeployment(config.teenxChild, {
  ...
  const app = await createApp(db as any, {
    uiMode,
    advxServerProfile: config.advxServerProfile,
    serverPort: listenPort,
    storageService,
    ...
    teenxChildConfig: config.teenxChild,
  });
