...
import { readTeenxChildConfig, type TeenxChildConfig } from "./teenx-child-config.js";
import {
  resolveAdvxServerProfile,
  type AdvxServerProfile,
} from "./services/advx-demo/profile.js";
...
export function loadConfig(): Config {
  ...
  const advxServerProfile = resolveAdvxServerProfile(
    process.env.ADVX_SERVER_PROFILE,
    {
      ...
      databaseUrl,
      managedConfig: process.env.PAPERCLIP_MANAGED_CONFIG,
      trustProxy: process.env.TRUST_PROXY,
      trustedMcpRuntimeHost:
  ...
  return {
    ...
    teenxChild: readTeenxChildConfig(process.env),
  };
}
