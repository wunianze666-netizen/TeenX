...
export function companySearchService(db: Db) {
  ...
  return {
    ...
    search: async (
      ...
      const genericReadCondition = genericIssueReadCondition(genericReadScope);
      ...
      async function fetchArtifactRows() {
        ...
        }, { issueConditions: [...issueFilters, genericReadCondition] });
